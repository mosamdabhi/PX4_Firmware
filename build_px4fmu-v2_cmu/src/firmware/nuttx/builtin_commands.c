...
extern int mocap_status_monitor_main(int argc, char *argv[]);
...
extern int mocap_control_main(int argc, char *argv[]);
...
const struct builtin_s g_builtins[] = {
	...
	{"mocap_status_monitor", SCHED_PRIORITY_DEFAULT, 1500, mocap_status_monitor_main},
	{"attitude_estimator_q", SCHED_PRIORITY_DEFAULT, 1200, attitude_estimator_q_main},
	{"local_position_estimator", SCHED_PRIORITY_DEFAULT, 9216, local_position_estimator_main},
	{"position_estimator_inav", SCHED_PRIORITY_DEFAULT, 1200, position_estimator_inav_main},
	{"mocap_control", SCHED_PRIORITY_DEFAULT, 2000, mocap_control_main},
